import { defineComponent as w, ref as _, openBlock as v, createElementBlock as f, createElementVNode as a, unref as m, withModifiers as c, createStaticVNode as D, watch as x, normalizeClass as g, Fragment as T, withDirectives as V, vShow as B, pushScopeId as F, popScopeId as I } from "vue";
/*! *****************************************************************************
...
const S = { class: "dropZone" }, z = ["id", "accept"], k = ["onDrop"], C = ["for"], L = /* @__PURE__ */ D('<svg width="10em" height="10em" viewBox="0 0 16 12" class="dropZoneImage" fill="currentColor" xmlns="http://www.w3.org/2000/svg" data-v-40def0a8><path fill-rule="evenodd" d="m 8.0274054,0.49415269 a 5.53,5.53 0 0 0 -3.594,1.34200001 c -0.766,0.66 -1.321,1.52 -1.464,2.383 -1.676,0.37 -2.94199993,1.83 -2.94199993,3.593 0,2.048 1.70799993,3.6820003 3.78099993,3.6820003 h 8.9059996 c 1.815,0 3.313,-1.43 3.313,-3.2270003 0,-1.636 -1.242,-2.969 -2.834,-3.194 -0.243,-2.58 -2.476,-4.57900001 -5.1659996,-4.57900001 z m 2.3539996,5.14600001 -1.9999996,-2 a 0.5,0.5 0 0 0 -0.708,0 l -2,2 a 0.5006316,0.5006316 0 1 0 0.708,0.708 l 1.146,-1.147 v 3.793 a 0.5,0.5 0 0 0 1,0 v -3.793 l 1.146,1.147 a 0.5006316,0.5006316 0 0 0 0.7079996,-0.708 z" data-v-40def0a8></path></svg><div class="dropZoneBody" data-v-40def0a8><p data-v-40def0a8><strong class="dropZoneTitle fg-inherit" data-v-40def0a8>Drag and drop files to upload</strong></p><p data-v-40def0a8><small class="dropZoneText" data-v-40def0a8>Your files will be added automatically</small></p><button type="button" class="button" data-v-40def0a8>or select files</button></div>', 2), M = [
  ...
  setup(e, { emit: d }) {
    const n = e, t = _([]), l = _(null), p = Z(), h = (u) => {
      const o = u.target.files || u.dataTransfer.files || l.value.files;
      for (let r = 0; r < o.length; r++) {
        const s = o[r];
        if (n.base64) {
          const i = new FileReader();
          i.onload = () => {
            s.base64 = i.result, t.value.unshift(s);
          }, i.readAsDataURL(s);
        } else
          t.value.unshift(s);
      }
...
const y = (e, d) => {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: d }) {
    const n = e, t = _(n.modelValue || {}), l = _(null), p = Z();
    x(() => n.modelValue, () => {
    ...
    const h = (u) => {
      const o = u.target.files || u.dataTransfer.files || l.value.files;
      for (let r = 0; r < o.length; r++) {
        const s = o[r], i = new FileReader();
        i.onload = () => {
          s.base64 = i.result, t.value = s;
        }, i.readAsDataURL(s);
      }
      d("update:modelValue", t.value);
    };
    return (u, o) => {
      ...
      return v(), f("div", A, [
        ...
        a("div", {
          class: g(["dropZoneWrap", (r = t.value) != null && r.base64 ? "tedirThumbnailHidden" : ""]),
          onDragenter: o[0] || (o[0] = c(() => {
          }, ["prevent"])),
          onDragover: o[1] || (o[1] = c(() => {
          }, ["prevent"])),
          ...
          a("label", {
            ...
            class: g(["dropZoneLabel", (s = t.value) != null && s.base64 ? "tedirThumbnailLabel" : ""])
          }, [
            (i = t.value) != null && i.base64 ? (v(), f("img", {
              key: 0,
              src: t.value.base64,
              class: "tedirThumbnailImage",
              alt: t.value.name
            }, null, 8, E)) : (v(), f(T, { key: 1 }, [
              (v(), f("svg", {
              ...
              a("div", H, [
                j,
                G,
                V(a("button", J, "or select thumbnail", 512), [
                  [B, e.showButton]
                ])
              ])
            ], 64))
...
const X = /* @__PURE__ */ y(K, [["__scopeId", "data-v-030ba619"]]);
export {
  Q as DropZone,
  X as ThumbBox
};
